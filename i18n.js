(function () {
    ...
    window.I18N = {
      en: {
          ...
          lang: { label: "Language" },
          btn: { tablet: "Tablet Support", "tablet.title": "Switch to Tablet Support", clock: "Toggle Live Clock (K)", add: "Add New Window (N)", layouts: "Toggle Layouts (L)", colour: "Website Colour (X)", color: "Select Accent Color (C)", magic: "Extract Color from Content (M)", themePalette: "Theme Palette (Z)", originalColor: "Original Colour", bell: "Ring Bell (B)", shh: "Shush Sound (S)", "shh.label": "Shh", management: "Classroom Management Tools (/)", help: "Help & Resources (?)", laser: "Toggle Laser Pointer (P)", tour: "Start Guided Tour", demo: "Show Demo Video", info: "Show Information", refresh: "Refresh Page (R)", share: "Share with a Friend (J)", feedback: "Provide Feedback (F)", coffee: "Buy Me a Coffee (Y)", upgrade: "Upgrade to Premium (U)" },
      ...
      cs: {
          ...
          lang: { label: "Jazyk" },
          btn: { tablet: "Podpora pro tablet", "tablet.title": "Přepnout na podporu pro tablet", clock: "Zobrazit/skryt živé hodiny (K)", add: "Přidat nové okno (N)", layouts: "Přepnout nástroje rozložení (L)", colour: "Barva webu (X)", color: "Zvolit zvýrazňovací barvu (C)", magic: "Extrahovat barvu z obsahu (M)", themePalette: "Paleta motivů (Z)", originalColor: "Původní barva", bell: "Zazvonit (B)", shh: "Zvuk Ticho (S)", "shh.label": "Pšš", management: "Nástroje pro správu třídy (/)", help: "Nápověda a zdroje (?)", laser: "Přepnout laserové ukazovátko (P)", tour: "Spustit prohlídku", demo: "Zobrazit ukázkové video", info: "Zobrazit informace", refresh: "Obnovit stránku (R)", share: "Sdílet s přítelem (J)", feedback: "Zpětná vazba (F)", coffee: "Pozvat na kávu (Y)", upgrade: "Přejít na Premium (U)" },
      ...
      pt: {
          ...
          lang: { label: "Idioma" },
          btn: { tablet: "Suporte para Tablet", "tablet.title": "Mudar para Suporte para Tablet", clock: "Alternar Relógio (K)", add: "Adicionar Janela (N)", layouts: "Alternar Layouts (L)", colour: "Cor do Site (X)", color: "Selecionar Cor (C)", magic: "Extrair Cor (M)", themePalette: "Paleta de Temas (Z)", originalColor: "Cor Original", bell: "Tocar Sino (B)", shh: "Som de 'Shh' (S)", "shh.label": "Shh", management: "Ferramientas de Gestão (/)", help: "Ajuda (?)", laser: "Ponteiro Laser (P)", tour: "Iniciar Tour", demo: "Vídeo de Demonstração", info: "Informações", refresh: "Atualizar (R)", share: "Compartilhar (J)", feedback: "Enviar Feedback (F)", coffee: "Pague-me um café (Y)", upgrade: "Atualizar para Premium (U)" },
