(function () {
    ...
    window.I18N = {
      ...
      pt: {
          ...
          lang: { label: "Idioma" },
          btn: { tablet: "Suporte para Tablet", "tablet.title": "Mudar para Suporte para Tablet", clock: "Alternar Relógio (K)", add: "Adicionar Janela (N)", layouts: "Alternar Layouts (L)", colour: "Cor do Site (X)", color: "Selecionar Cor (C)", magic: "Extrair Cor (M)", themePalette: "Paleta de Temas (Z)", originalColor: "Cor Original", bell: "Tocar Sino (B)", shh: "Som de 'Shh' (S)", "shh.label": "Shh", management: "Ferramentas de Gestão (/)", help: "Ajuda (?)", laser: "Ponteiro Laser (P)", tour: "Iniciar Tour", demo: "Vídeo de Demonstração", info: "Informações", refresh: "Atualizar (R)", share: "Compartilhar (J)", feedback: "Enviar Feedback (F)", coffee: "Pague-me um café (Y)", upgrade: "Atualizar para Premium (U)" },
