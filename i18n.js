(function () {
    ...
    const i18nData = {
      ...
      uk: {
          meta: { title: "Teacher Toybox | Безкоштовна інтерактивна дошка для вчителів", titleShort: "Teacher Toybox | Інтерактивна дошка", description: "Teacher Toybox — це безкоштовна інтерактивна цифрова доška з таймерами, кубиками та іншим, щоб зробити уроки захоплюючими. Встановлення не потрібне.", keywords: "цифрова дошка, інтерактивна доška, інструменти для вчителів, ресурси для класу, безкоштовні інструменти для вчителів, онлайн-таймер, класні заходи, освіта" },
          ...
          panel: {
              ...
              share: { title: "Поділитися з другом" },
      ...
      hi: {
          ...
          panel: {
              ...
              share: { title: "मित्र के साथ साझा करें" },
      ...
      fa: {
          ...
          panel: {
              ...
              share: { title: "اشتراک‌گذاری با یک دوست" },
      ...
      pt: {
          ...
          panel: {
              ...
              share: { title: "Compartilhar com um amigo" },
      ...
      ru: {
          ...
          panel: {
              ...
              share: { title: "Поделиться с другом" },
